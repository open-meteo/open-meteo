...
final class DownloaderTests: XCTestCase {
    func testAwsSign() async throws {
        ...
        XCTAssertEqual(signingKey.hex, "cbcef1ebeaefc82cce6530b9f0a9ae598846065f5c5bae0674bd5ebc4ba52d28")
        
        try signer.sign(request: &request, body: nil, now: Date.init("2013-05-24T00:00:00Z", strategy: .iso8601))
        
        XCTAssertEqual(request.headers.first(name: "Authorization"), "AWS4-HMAC-SHA256 Credential=AKIAIOSFODNN7EXAMPLE/20130524/us-east-1/s3/aws4_request, SignedHeaders=host;range;x-amz-content-sha256;x-amz-date, Signature=f0e8bdb87c964420e857bd35b5d6ed310bd44f0170aba48dd91039c6036bdb41")
