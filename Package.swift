...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "65c635332d487556f86baf181ae6311f0c5dcd04"), // Because unsafe C flags are set, tagged releases cannot be used
