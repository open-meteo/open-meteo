...
struct DownloadEra5Command: AsyncCommand {
    ...
    func convertDailyFiles(logger: Logger, timeinterval: TimerangeDt, domain: CdsDomain, variables: [GenericVariable]) throws {
        ...
        for variable in variables {
            ...
            try om.updateFromTimeOrientedStreaming(variable: variable.omFileName.file, time: timeintervalHourly, skipFirst: 0, smooth: 0, skipLast: 0, scalefactor: variable.scalefactor) { dim0 in
