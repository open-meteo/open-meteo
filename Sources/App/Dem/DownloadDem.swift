        ...
        try await withThrowingTaskGroup(of: Void.self) { group in
            for lon in -180..<180 {
                for lat in -90..<90 {
                    ...
                    group.addTask {
                        ...
                        try OmFileWriter(dim0: data.dimensions[0], dim1: data.dimensions[1], chunk0: 20, chunk1: 20).write(file: omFile, compressionType: .pfor_delta2d_16bit, scalefactor: 1, all: data.data)
                    }
                }
            }
            ...
            for lat in -90..<90 {
                ...
                group.addTask {
                    ...
                    try OmFileWriter(dim0: 1200, dim1: px*360, chunk0: 60, chunk1: 60).write(file: file.getFilePath(), compressionType: .pfor_delta2d_16bit, scalefactor: 1, all: line)
                }
            }
