...
extension AsyncSequence where Element == ByteBuffer, Self: Sendable {
     ...
     */
    public func decodeBzip2(nConcurrent: Int = 4) -> AsyncConcurrentMapSequence<Bzip2AsyncStream<Self>, ByteBuffer> {
        return Bzip2AsyncStream(sequence: self).mapStream(nConcurrent: nConcurrent) { try $0() }
    }
}
...
public struct Bzip2AsyncStream<T: AsyncSequence>: AsyncSequence where T.Element == ByteBuffer {
    ...
    public final class AsyncIterator: AsyncIteratorProtocol {
        ...
        public func next() async throws -> (@Sendable () throws -> ByteBuffer)? {
