...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "5d6cb513747d8216a9e5d338fcc5cf4273fe2fda"), // Because unsafe C flags are set, tagged releases cannot be used
