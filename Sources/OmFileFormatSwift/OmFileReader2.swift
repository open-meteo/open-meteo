...
public struct OmFileReader2<Backend: OmFileReaderBackend> {
    ...
    /// Read variable as float array
    public func read(_ dimRead: [Range<UInt64>]? = nil, io_size_max: UInt64 = 65536, io_size_merge: UInt64 = 512) throws -> [Float] {
    ...
    public func read<OmType: OmFileArrayDataTypeProtocol>(into: UnsafeMutablePointer<OmType>, dimRead: [Range<UInt64>], intoCubeOffset: [UInt64]? = nil, intoCubeDimension: [UInt64]? = nil, io_size_max: UInt64 = 65536, io_size_merge: UInt64 = 512) throws {
