...
struct OmFileSplitter {
     ...
     */
    func updateFromSpaceOriented(variable: String, array2d: Array2DFastSpace, ringtime: Range<Int>, skipFirst: Int, smooth: Int, skipLast: Int, scalefactor: Float) throws {
            ...
            try OmFileWriter.write(file: tempFile, compressionType: .p4nzdec256, scalefactor: scalefactor, dim0: nLocations, dim1: nTimePerFile, chunk0: chunknLocations, chunk1: nTimePerFile, supplyChunk: {
                ...
                for l in 0..<locationRange.count {
                    for (tFile,tArray) in zip(offsets.file, offsets.array) {
                        ...
                        fileData[nTimePerFile * l + tFile] = array2d.data[array2d.nLocations * tArray + l + d0offset]
                    }
                }
