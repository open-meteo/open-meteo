...
@Suite struct AirQualityTests {
    ...
    @Test func camsUsesGenericMappings() throws {
        ...
        #expect(CamsQuery.Domain.auto.multiDomain == .air_quality_best_match)
        #expect(CamsQuery.Domain.cams_global.multiDomain == .cams_global)
        #expect(CamsQuery.Domain.cams_europe.multiDomain == .cams_europe)
