...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "7b5a658bf0803b1f117f2323d2be28847be43bc2"), // Because unsafe C flags are set, tagged releases cannot be used
