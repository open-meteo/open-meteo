...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "fcda3d94e7882cc462b2be3e7e5a360fb47956ba"), // Because unsafe C flags are set, tagged releases cannot be used
