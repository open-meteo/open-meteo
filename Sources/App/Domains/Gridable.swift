...
extension Gridable {
    ...
    func findPoint(lat: Float, lon: Float, elevation: Float, elevationFile: OmFileReader2Array<MmapFile, Float>?, mode: GridSelectionMode) throws -> (gridpoint: Int, gridElevation: ElevationOrSea)? {
    ...
    func readElevation(gridpoint: Int, elevationFile: OmFileReader2Array<MmapFile, Float>) throws -> ElevationOrSea {
    ...
    func readElevationInterpolated(gridpoint: GridPoint2DFraction, elevationFile: OmFileReader2Array<MmapFile, Float>) throws -> ElevationOrSea {
    ...
    func readFromStaticFile(gridpoint: Int, file: OmFileReader2Array<MmapFile, Float>) throws -> Float {
    ...
    func findPointNearest(lat: Float, lon: Float, elevationFile: OmFileReader2Array<MmapFile, Float>) throws -> (gridpoint: Int, gridElevation: ElevationOrSea)? {
    ...
    func findPointInSea(lat: Float, lon: Float, elevationFile: OmFileReader2Array<MmapFile, Float>) throws -> (gridpoint: Int, gridElevation: ElevationOrSea)? {
        guard let center = findPoint(lat: lat, lon: lon) else {
            return nil
        }
        let x = center % nx
    ...
    func findPointTerrainOptimised(lat: Float, lon: Float, elevation: Float, elevationFile: OmFileReader2Array<MmapFile, Float>) throws -> (gridpoint: Int, gridElevation: ElevationOrSea)? {
        guard let center = findPoint(lat: lat, lon: lon) else {
            return nil
        }
        let x = center % nx
