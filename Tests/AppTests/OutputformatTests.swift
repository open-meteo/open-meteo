...
final class OutputformatTests: XCTestCase {
    ...
    func testFormats() throws {
        ...
        XCTAssertEqual(csv, """
            latitude,longitude,elevation,utc_offset_seconds,timezone,timezone_abbreviation,elevation_raw
            41.0,2.0,NaN,3600,GMT,GMT,NaN
