...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "6c2002f8cd16ccaf6dbe6611549e18aabd652ab7"), // Because unsafe C flags are set, tagged releases cannot be used
