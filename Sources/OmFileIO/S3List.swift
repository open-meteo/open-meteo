...
public enum S3List {
    ...
    public struct ListV2Query: Codable {
        public let list_type: Int
        public let delimiter: String
        public let prefix: String
        public let apikey: String?
        public let continuation_token: String?
    ...
    public struct ListV2File: Sendable {
        public let name: String
        public let modificationTime: Timestamp
    ...
    public static func s3list(server: String, client: HTTPClient, logger: Logger, prefix: String, apikey: String?, deadLineHours: Double) async throws -> (files: [S3List.ListV2File], directories: [String]) {
