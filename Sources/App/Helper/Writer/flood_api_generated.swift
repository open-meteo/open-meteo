...
public enum com_openmeteo_flood_api_FloodModel: Int8, Enum, Verifiable {
  ...
  public static var max: com_openmeteo_flood_api_FloodModel { return .glofasConsolidatedV4 }
  public static var min: com_openmeteo_flood_api_FloodModel { return .bestMatch }
}


public struct com_openmeteo_flood_api_FloodDaily: FlatBufferObject, Verifiable {
  ...
  public static func createFloodDaily(
    ...
    let __start = com_openmeteo_flood_api_FloodDaily.startFloodDaily(&fbb)
    com_openmeteo_flood_api_FloodDaily.addVectorOf(riverDischargeMean: riverDischargeMean, &fbb)
    com_openmeteo_flood_api_FloodDaily.addVectorOf(riverDischargeMin: riverDischargeMin, &fbb)
    com_openmeteo_flood_api_FloodDaily.addVectorOf(riverDischargeMax: riverDischargeMax, &fbb)
    com_openmeteo_flood_api_FloodDaily.addVectorOf(riverDischargeMedian: riverDischargeMedian, &fbb)
    com_openmeteo_flood_api_FloodDaily.addVectorOf(riverDischargeP25: riverDischargeP25, &fbb)
    com_openmeteo_flood_api_FloodDaily.addVectorOf(riverDischargeP75: riverDischargeP75, &fbb)
    return com_openmeteo_flood_api_FloodDaily.endFloodDaily(&fbb, start: __start)
  }
...
public struct com_openmeteo_flood_api_FloodDailyUnits: FlatBufferObject, Verifiable {
  ...
  public var riverDischargeMean: SiUnit { let o = _accessor.offset(VTOFFSET.riverDischargeMean.v); return o == 0 ? .undefined : SiUnit(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .undefined }
  public var riverDischargeMin: SiUnit { let o = _accessor.offset(VTOFFSET.riverDischargeMin.v); return o == 0 ? .undefined : SiUnit(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .undefined }
  public var riverDischargeMax: SiUnit { let o = _accessor.offset(VTOFFSET.riverDischargeMax.v); return o == 0 ? .undefined : SiUnit(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .undefined }
  public var riverDischargeMedian: SiUnit { let o = _accessor.offset(VTOFFSET.riverDischargeMedian.v); return o == 0 ? .undefined : SiUnit(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .undefined }
  public var riverDischargeP25: SiUnit { let o = _accessor.offset(VTOFFSET.riverDischargeP25.v); return o == 0 ? .undefined : SiUnit(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .undefined }
  public var riverDischargeP75: SiUnit { let o = _accessor.offset(VTOFFSET.riverDischargeP75.v); return o == 0 ? .undefined : SiUnit(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .undefined }
  public static func startFloodDailyUnits(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 6) }
  public static func add(riverDischargeMean: SiUnit, _ fbb: inout FlatBufferBuilder) { fbb.add(element: riverDischargeMean.rawValue, def: 0, at: VTOFFSET.riverDischargeMean.p) }
  public static func add(riverDischargeMin: SiUnit, _ fbb: inout FlatBufferBuilder) { fbb.add(element: riverDischargeMin.rawValue, def: 0, at: VTOFFSET.riverDischargeMin.p) }
  public static func add(riverDischargeMax: SiUnit, _ fbb: inout FlatBufferBuilder) { fbb.add(element: riverDischargeMax.rawValue, def: 0, at: VTOFFSET.riverDischargeMax.p) }
  public static func add(riverDischargeMedian: SiUnit, _ fbb: inout FlatBufferBuilder) { fbb.add(element: riverDischargeMedian.rawValue, def: 0, at: VTOFFSET.riverDischargeMedian.p) }
  public static func add(riverDischargeP25: SiUnit, _ fbb: inout FlatBufferBuilder) { fbb.add(element: riverDischargeP25.rawValue, def: 0, at: VTOFFSET.riverDischargeP25.p) }
  public static func add(riverDischargeP75: SiUnit, _ fbb: inout FlatBufferBuilder) { fbb.add(element: riverDischargeP75.rawValue, def: 0, at: VTOFFSET.riverDischargeP75.p) }
  ...
  public static func createFloodDailyUnits(
    _ fbb: inout FlatBufferBuilder,
    riverDischargeMean: SiUnit = .undefined,
    riverDischargeMin: SiUnit = .undefined,
    riverDischargeMax: SiUnit = .undefined,
    riverDischargeMedian: SiUnit = .undefined,
    riverDischargeP25: SiUnit = .undefined,
    riverDischargeP75: SiUnit = .undefined
  ) -> Offset {
    let __start = com_openmeteo_flood_api_FloodDailyUnits.startFloodDailyUnits(&fbb)
    com_openmeteo_flood_api_FloodDailyUnits.add(riverDischargeMean: riverDischargeMean, &fbb)
    com_openmeteo_flood_api_FloodDailyUnits.add(riverDischargeMin: riverDischargeMin, &fbb)
    com_openmeteo_flood_api_FloodDailyUnits.add(riverDischargeMax: riverDischargeMax, &fbb)
    com_openmeteo_flood_api_FloodDailyUnits.add(riverDischargeMedian: riverDischargeMedian, &fbb)
    com_openmeteo_flood_api_FloodDailyUnits.add(riverDischargeP25: riverDischargeP25, &fbb)
    com_openmeteo_flood_api_FloodDailyUnits.add(riverDischargeP75: riverDischargeP75, &fbb)
    return com_openmeteo_flood_api_FloodDailyUnits.endFloodDailyUnits(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.riverDischargeMean.p, fieldName: "riverDischargeMean", required: false, type: SiUnit.self)
    try _v.visit(field: VTOFFSET.riverDischargeMin.p, fieldName: "riverDischargeMin", required: false, type: SiUnit.self)
    try _v.visit(field: VTOFFSET.riverDischargeMax.p, fieldName: "riverDischargeMax", required: false, type: SiUnit.self)
    try _v.visit(field: VTOFFSET.riverDischargeMedian.p, fieldName: "riverDischargeMedian", required: false, type: SiUnit.self)
    try _v.visit(field: VTOFFSET.riverDischargeP25.p, fieldName: "riverDischargeP25", required: false, type: SiUnit.self)
    try _v.visit(field: VTOFFSET.riverDischargeP75.p, fieldName: "riverDischargeP75", required: false, type: SiUnit.self)
    _v.finish()
  }
}

public struct com_openmeteo_flood_api_FloodApiResponse: FlatBufferObject, Verifiable {
  ...
  public var model: com_openmeteo_flood_api_FloodModel { let o = _accessor.offset(VTOFFSET.model.v); return o == 0 ? .bestMatch : com_openmeteo_flood_api_FloodModel(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .bestMatch }
  ...
  public var daily: com_openmeteo_flood_api_FloodDaily? { let o = _accessor.offset(VTOFFSET.daily.v); return o == 0 ? nil : com_openmeteo_flood_api_FloodDaily(_accessor.bb, o: _accessor.indirect(o + _accessor.postion)) }
  public var dailyUnits: com_openmeteo_flood_api_FloodDailyUnits? { let o = _accessor.offset(VTOFFSET.dailyUnits.v); return o == 0 ? nil : com_openmeteo_flood_api_FloodDailyUnits(_accessor.bb, o: _accessor.indirect(o + _accessor.postion)) }
  ...
  public static func add(model: com_openmeteo_flood_api_FloodModel, _ fbb: inout FlatBufferBuilder) { fbb.add(element: model.rawValue, def: 0, at: VTOFFSET.model.p) }
  ...
  public static func createFloodApiResponse(
    ...
    model: com_openmeteo_flood_api_FloodModel = .bestMatch,
    ...
    let __start = com_openmeteo_flood_api_FloodApiResponse.startFloodApiResponse(&fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(latitude: latitude, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(longitude: longitude, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(elevation: elevation, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(model: model, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(generationtimeMs: generationtimeMs, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(utcOffsetSeconds: utcOffsetSeconds, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(timezone: timezone, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(timezoneAbbreviation: timezoneAbbreviation, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(timeStart: timeStart, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(daily: daily, &fbb)
    com_openmeteo_flood_api_FloodApiResponse.add(dailyUnits: dailyUnits, &fbb)
    return com_openmeteo_flood_api_FloodApiResponse.endFloodApiResponse(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.model.p, fieldName: "model", required: false, type: com_openmeteo_flood_api_FloodModel.self)
    ...
    try _v.visit(field: VTOFFSET.daily.p, fieldName: "daily", required: false, type: ForwardOffset<com_openmeteo_flood_api_FloodDaily>.self)
    try _v.visit(field: VTOFFSET.dailyUnits.p, fieldName: "dailyUnits", required: false, type: ForwardOffset<com_openmeteo_flood_api_FloodDailyUnits>.self)
    _v.finish()
  }
}
