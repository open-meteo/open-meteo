...
struct DownloadCmipCommand: AsyncCommand {
    ...
    func run(using context: CommandContext, signature: Signature) async throws {
        ...
        if let version = domain.versionOrography, !FileManager.default.fileExists(atPath: domain.surfaceElevationFileOm.getFilePath()) {
            ...
            try OmFileWriter(dim0: domain.grid.ny, dim1: domain.grid.nx, chunk0: 20, chunk1: 20).write(file: domain.surfaceElevationFileOm.getFilePath(), compressionType: .pfor_delta2d_16bit, scalefactor: 1, all: altitude.data)
            ...
            for variable in variables {
                ...
                case .restoreFrom(dt: let dt, shortName: let shortName, aggregate: let aggregate):
                    ...
                    for month in 1...12 {
                        ...
                        if !FileManager.default.fileExists(atPath: monthlyOmFile) {
                            ...
                            try OmFileWriter(dim0: array.nLocations, dim1: array.nTime, chunk0: Self.nLocationsPerChunk, chunk1: array.nTime).write(file: monthlyOmFile, compressionType: .pfor_delta2d_16bit, scalefactor: short == "huss" ? 100 : variable.scalefactor, all: array.data)
                        }
                    }
                    ...
                    if shortName == "ps" {
                        ...
                        try OmFileWriter(dim0: domain.grid.count, dim1: nt, chunk0: 6, chunk1: 183).write(logger: logger, file: omFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, nLocationsPerChunk: Self.nLocationsPerChunk, chunkedFiles: monthlyReader, dataCallback: { (surfacePressure6h, locationRange) in
                    ...
                    if shortName == "hurs" {
                        ...
                        try OmFileWriter(dim0: domain.grid.count, dim1: nt, chunk0: 6, chunk1: 183).write(file: omFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, overwrite: false, supplyChunk: { dim0 in
                    ...
                    try OmFileWriter(dim0: domain.grid.count, dim1: nt, chunk0: 6, chunk1: 183).write(logger: logger, file: omFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, nLocationsPerChunk: Self.nLocationsPerChunk, chunkedFiles: monthlyReader, dataCallback: { (data6h, locationRange) in
                ...
                case .monthly:
                    ...
                    for month in 1...12 {
                        ...
                        if !FileManager.default.fileExists(atPath: monthlyOmFile) {
                            ...
                            try FileManager.default.removeItem(atPath: ncFile)
                            try OmFileWriter(dim0: array.nLocations, dim1: array.nTime, chunk0: Self.nLocationsPerChunk, chunk1: array.nTime).write(file: monthlyOmFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, all: array.data)
                        }
                    }
                    ...
                    try OmFileWriter(dim0: domain.grid.count, dim1: nt, chunk0: 6, chunk1: 183).write(logger: logger, file: omFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, nLocationsPerChunk: Self.nLocationsPerChunk, chunkedFiles: monthlyReader, dataCallback: nil)
                ...
                /*case .halfYearly:
                    ...
                    if !FileManager.default.fileExists(atPath: monthlyOmFile2) {
                        ...
                        try OmFileWriter(dim0: array.nLocations, dim1: array.nTime, chunk0: Self.nLocationsPerChunk, chunk1: array.nTime).write(file: monthlyOmFile2, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, all: array.data)
                    }
                    ...
                    /// Process around 200 MB memory at once
                    try OmFileWriter(dim0: domain.grid.count, dim1: nt, chunk0: 6, chunk1: 183).write(logger: logger, file: omFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, nLocationsPerChunk: Self.nLocationsPerChunk, chunkedFiles: monthlyReader)
                ...
                case .yearly:
                    ...
                    try OmFileWriter(dim0: array.nLocations, dim1: array.nTime, chunk0: 6, chunk1: 183).write(file: omFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, all: array.data)
                    if deleteNetCDF {
                        try FileManager.default.removeItem(atPath: ncFile)
                    }
                case .tenYearly:
        ...
        for variable in variables {
            ...
            try OmFileWriter(dim0: domain.grid.count, dim1: TimerangeDt(range: domain.masterTimeRange!, dtSeconds: domain.dtSeconds).count, chunk0: 8, chunk1: 512)
                .write(logger: logger, file: masterFile, compressionType: .pfor_delta2d_16bit, scalefactor: variable.scalefactor, nLocationsPerChunk: 600, chunkedFiles: yearlyReader, dataCallback: nil)
        }
