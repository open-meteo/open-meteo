...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "57a34ce1d53e4d75b1d93c22ab6581c2e45be339"), // Because unsafe C flags are set, tagged releases cannot be used
