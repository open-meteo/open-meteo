...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "2dd19d4dfc473c35fd278cfa5f5728105a34806c"), // Because unsafe C flags are set, tagged releases cannot be used
