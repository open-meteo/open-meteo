...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "f9dea31eba3280b4de39d9ce81acd559ce5bcc56"), // Because unsafe C flags are set, tagged releases cannot be used
