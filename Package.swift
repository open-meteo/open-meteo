...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "d8855e418e2231ae8439f0c7e840fa3f93b371e3"), // Because unsafe C flags are set, tagged releases cannot be used
