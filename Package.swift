...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "3b8974a8e854996bb360bc7d75c0fb5ec000cfa3"), // Because unsafe C flags are set, tagged releases cannot be used
