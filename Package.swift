...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "d44c4c337c8c70d8c9f0567c10a5e4a4c198c29c"), // Because unsafe C flags are set, tagged releases cannot be used
