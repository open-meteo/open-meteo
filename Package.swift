...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "a6d0d28173d4ef689fed6f9344d195af3f8f9a0f"), // Because unsafe C flags are set, tagged releases cannot be used
