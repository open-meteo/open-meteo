...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "702ceb4f636dfb21fb69b6ccc9dd2a90bdbcb925"), // Because unsafe C flags are set, tagged releases cannot be used
