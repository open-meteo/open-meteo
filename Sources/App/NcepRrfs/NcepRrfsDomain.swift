...
enum NcepRrfsDomain: String, CaseIterable, GenericDomain {
    ...
    var domainRegistryStatic: DomainRegistry? { .ncep_rrfs_conus }
    ...
    var forecastHours: ClosedRange<Int> {
        switch self {
        case .ncep_rrfs_conus: return 0...84
    ...
    var grid: any Gridable { projectedGrid }
    var projectedGrid: ProjectionGrid<LambertConformalConicProjection> {
