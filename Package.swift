...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "5c5ef502fb5b1164b17854f4226a2ed2ad9a1887"), // Because unsafe C flags are set, tagged releases cannot be used
