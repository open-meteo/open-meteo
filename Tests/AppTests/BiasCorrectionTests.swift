...
@Suite struct BiasCorrectionTests {
    ...
    @Test func dailyNormals() {
        ...
        #expect(arraysEqual(normals[0..<10], [33.16129, 34.73077, 32.92, 33.0, 33.08, 33.16, 33.24, 33.36, 33.48, 33.6], accuracy: 0.001))
        ...
        #expect(arraysEqual(normals2, [Float](repeating: 10, count: normals2.count), accuracy: 0.001))
    }
}
