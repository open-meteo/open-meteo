...
struct VariableHourlyDeriver<Reader: GenericReaderProtocol>: GenericDeriverProtocol {
    ...
    func getDeriverMap(variable: ForecastSurfaceVariable) -> DerivedMapping<Reader.MixingVar>? {
        ...
        case .us_aqi_pm2_5:
            ...
            return .one(.mapped(.runningMean(.raw(pm2_5), windowSeconds: 24 * 3600))) { pm2_5, _ in
        ...
        case .us_aqi_pm10:
            ...
            return .one(.mapped(.runningMean(.raw(pm10), windowSeconds: 24 * 3600))) { pm10, _ in
        ...
        case .us_aqi_ozone, .us_aqi_o3:
            ...
            return .two(.raw(ozone), .mapped(.runningMean(.raw(ozone), windowSeconds: 8 * 3600))) { ozone, ozoneMean, _ in
        ...
        case .us_aqi_sulphur_dioxide, .us_aqi_so2:
            ...
            return .two(.raw(sulphurDioxide), .mapped(.runningMean(.raw(sulphurDioxide), windowSeconds: 24 * 3600))) { sulphurDioxide, sulphurDioxideMean, _ in
        ...
        case .us_aqi_carbon_monoxide, .us_aqi_co:
            ...
            return .one(.mapped(.runningMean(.raw(carbonMonoxide), windowSeconds: 8 * 3600))) { carbonMonoxide, _ in
