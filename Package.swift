...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "89a0415fee93b2ef7e555d937caa1eea893512e8"), // Because unsafe C flags are set, tagged releases cannot be used
