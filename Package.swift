...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "e6a735533902d43a3704c0af2f8dd632110083f1"), // Because unsafe C flags are set, tagged releases cannot be used
