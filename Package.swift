...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "6f3328dfc996cc0b76b660863b9be9a0b606fd8e"), // Because unsafe C flags are set, tagged releases cannot be used
