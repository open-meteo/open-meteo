...
fileprivate extension Array2DFastTime {
    func writeCfs(om: OmFileSplitter, logger: Logger, variable: CfsVariable, member: Int, run: Timestamp, dtSeconds: Int) throws {
        ...
        try om.updateFromTimeOriented(variable: "\(variable.rawValue)_member\(member)", array2d: self, time: time, skipFirst: 1, smooth: 0, skipLast: 0, scalefactor: variable.scalefactor)
