...
public extension Range where Element == Int {
    ...
    func intersect(fileTime: Range<Int>) -> (file: CountableRange<Int>, array: CountableRange<Int>)? {
    ...
    @inlinable func add(_ offset: Int) -> Range<Int> {
        return lowerBound + offset ..< upperBound + offset
    }

    @inlinable func multiply(_ by: Int) -> Range<Int> {
