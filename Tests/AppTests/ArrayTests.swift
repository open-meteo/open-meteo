...
final class ArrayTests: XCTestCase {
    ...
    func testSolfactorBackwards() {
        ...
        let solfac2 = Zensun.calculateRadiationBackwardsAveraged(grid: grid, timerange: time).data
...
func XCTAssertEqual<T: Collection>(_ a: T, _ b: T, accuracy: Float) where T.Element == Float {
