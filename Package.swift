...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/open-meteo/om-file-format.git", revision: "b7f1cf24e18d833084d271662cac38867731cc7f"), // Because unsafe C flags are set, tagged releases cannot be used
