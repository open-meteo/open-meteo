...
struct EumetsatSarahReader: GenericReaderDerived, GenericReaderProtocol {
    ...
    func prefetchData(raw: EumetsatSarahVariable, time: TimerangeDtAndSettings) async throws {
        try await reader.prefetchData(variable: raw, time: time)
    }

    func get(raw: EumetsatSarahVariable, time: TimerangeDtAndSettings) async throws -> DataAndUnit {
    ...
    func prefetchData(derived: Derived, time: TimerangeDtAndSettings) async throws {
        ...
        case .direct_normal_irradiance, .direct_normal_irradiance_instant, .direct_radiation_instant, .sunshine_duration:
