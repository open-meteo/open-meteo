...
public struct Bzip2AsyncStream<T: AsyncSequence>: AsyncSequence where T.Element == ByteBuffer {
    ...
    public final class AsyncIterator: AsyncIteratorProtocol {
        ...
        var tasks: CircularBuffer<Task<ByteBuffer, any Error>>? = nil
        let nConcurrent: Int
        ...
        public func next() async throws -> ByteBuffer? {
            guard tasks != nil else {
                ...
                var tasks = CircularBuffer<Task<ByteBuffer, any Error>>(initialCapacity: nConcurrent + 1)
        ...
        public func decodeNext() async throws -> (@Sendable () throws -> ByteBuffer)? {
    ...
    public func makeAsyncIterator() -> AsyncIterator {
        AsyncIterator(iterator: sequence.makeAsyncIterator(), nConcurrent: nConcurrent)
    }
}
...
extension decoder_state: @unchecked @retroactive Sendable {
