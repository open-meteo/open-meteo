...
public final actor TransferAmountTracker: Sendable {
    public nonisolated let transfered = Atomic(0)
...
public extension AsyncSequence where Self: Sendable, Element == ByteBuffer {
...
public struct TransferAmountTrackerStream<T: AsyncSequence>: Sendable, AsyncSequence where T.Element == ByteBuffer, T: Sendable {
